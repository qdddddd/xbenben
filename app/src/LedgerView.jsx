...
<button type="button" onClick={v.goActive} style={{"width": "100%", "marginTop": "var(--size-26)", "padding": "var(--size-13) var(--size-14)", "background": "var(--color-accent)", "color": "var(--color-bg)", "borderColor": "var(--color-accent)", "display": "flex", "alignItems": "center", "gap": "var(--size-10)", "cursor": "pointer", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-15)", "letterSpacing": ".12em", "textTransform": "uppercase"}} className="blueprint"><i aria-hidden="true" className="corner tl"></i><i aria-hidden="true" className="corner tr"></i><i aria-hidden="true" className="corner bl"></i><i aria-hidden="true" className="corner br"></i>
...
<span style={{"fontSize": "var(--size-13)"}}>{"RESUME →"}</span>
</button>

</>}
{v.noActive && <>

<button type="button" onClick={v.goNew} style={{"width": "100%", "marginTop": "var(--size-26)", "padding": "var(--size-15) var(--size-14)", "background": "var(--color-accent)", "color": "var(--color-bg)", "borderColor": "var(--color-accent)", "display": "flex", "alignItems": "center", "justifyContent": "center", "gap": "var(--size-8)", "cursor": "pointer", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-16)", "letterSpacing": ".14em", "textTransform": "uppercase"}} className="blueprint interaction-0"><i aria-hidden="true" className="corner tl"></i><i aria-hidden="true" className="corner tr"></i><i aria-hidden="true" className="corner bl"></i><i aria-hidden="true" className="corner br"></i>
...
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-11)", "letterSpacing": ".16em", "textTransform": "uppercase", "color": "var(--color-accent-700)"}}>{"Recent"}</div>
<button type="button" onClick={v.goLog} style={{"background": "transparent", "border": "0", "cursor": "pointer", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-11)", "letterSpacing": ".1em", "textTransform": "uppercase", "color": "var(--color-neutral-700)", "padding": "0"}}>{"All " + (v.sessionCount) + " →"}</button>
</div>
{v.noSessions && <>
...
<span style={{"display": "block", "fontSize": "var(--size-10)", "fontFamily": "var(--font-heading)", "letterSpacing": ".08em", "textTransform": "uppercase", "color": "var(--color-neutral-600)"}}>{(r.rate) + "/h"}</span>
</span>
</button>
...
<button type="button" onClick={f.onClick} style={{"flex": "1", "padding": "var(--size-9) 0", "background": f.bg, "color": f.fg, "border": "0", "borderLeft": "var(--size-1) solid var(--color-divider)", "cursor": "pointer", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-12)", "letterSpacing": ".14em", "textTransform": "uppercase"}}>{f.label}</button>
...
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-16)", "letterSpacing": ".08em", "textTransform": "uppercase"}}>{v.logEmptyTitle}</div>
<div style={{"fontSize": "var(--size-12)", "lineHeight": "1.45", "color": "var(--color-neutral-700)", "maxWidth": "var(--size-238)"}}>{v.logEmptyLine}</div>
</div>
...
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-16)", "letterSpacing": ".08em", "textTransform": "uppercase"}}>{"No " + (v.currency) + " data yet"}</div>
<div style={{"fontSize": "var(--size-12)", "lineHeight": "1.45", "color": "var(--color-neutral-700)", "maxWidth": "var(--size-238)"}}>{v.emptyLine}</div>
<button type="button" onClick={v.openImport} style={{"marginTop": "var(--size-4)", "fontSize": "var(--size-12)", "letterSpacing": ".12em", "textTransform": "uppercase", "padding": "var(--size-9) var(--size-14)"}} className="btn btn-secondary">{"Import from analytics7"}</button>
</div>
...
<div style={{"display": "flex", "justifyContent": "space-between", "borderTop": "var(--size-1) solid var(--color-divider)", "padding": "var(--size-7) 0 var(--size-9)", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-10)", "letterSpacing": ".12em", "textTransform": "uppercase", "color": "var(--color-neutral-600)"}}>
...
<tr>
<td style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-15)"}}>{b.label}</td>
...
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-11)", "letterSpacing": ".16em", "textTransform": "uppercase", "color": "var(--color-accent-700)", "marginTop": "var(--size-24)"}}>{"Superlatives"}</div>
<div style={{"marginTop": "var(--size-6)", "borderTop": "var(--size-1) solid var(--color-divider)"}}>
...
<span style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-11)", "letterSpacing": ".12em", "textTransform": "uppercase", "color": "var(--color-neutral-700)", "flex": "none"}}>{s.label}</span>
<span style={{"flex": "1", "textAlign": "right", "fontSize": "var(--size-13)"}}>{s.value}</span>
<span style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-16)", "fontVariantNumeric": "tabular-nums", "flex": "none", "color": s.color}}>{s.figure}</span>
</div>
...
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-26)", "letterSpacing": ".02em"}}>{"SETTINGS"}</div>
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-11)", "letterSpacing": ".16em", "textTransform": "uppercase", "color": "var(--color-accent-700)", "marginTop": "var(--size-22)"}}>{"Defaults"}</div>
<div style={{"marginTop": "var(--size-6)", "borderTop": "var(--size-1) solid var(--color-divider)"}}>
{v.setRows.map((s, index) => <Fragment key={s.id ?? index}>

<button type="button" onClick={s.onClick} style={{"width": "100%", "display": "flex", "alignItems": "center", "gap": "var(--size-10)", "textAlign": "left", "background": "transparent", "border": "0", "borderBottom": "var(--size-1) solid var(--color-divider)", "padding": "var(--size-13) var(--size-2)", "cursor": "pointer", "fontFamily": "var(--font-body)", "fontSize": "var(--size-14)", "color": "var(--color-text)"}} className="interaction-3">
<span style={{"flex": "1"}}>{s.label}</span>
<span style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-15)", "color": "var(--color-accent-700)"}}>{s.value}</span>
...
<span style={{"flex": "1"}}>
<span style={{"display": "block", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-15)", "letterSpacing": ".04em"}}>{"Import from analytics7"}</span>
<span style={{"display": "block", "fontSize": "var(--size-11)", "color": "var(--color-neutral-700)"}}>{"Model .xml export · cash sessions"}</span>
</span>
<svg aria-hidden="true" focusable="false" width={"14"} height={"14"} viewBox={"0 0 24 24"} fill={"none"} stroke={"var(--color-neutral-500)"} strokeWidth={"1.5"}><path d={"M9 6l6 6-6 6"}></path></svg>
</button>
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-11)", "letterSpacing": ".16em", "textTransform": "uppercase", "color": "var(--color-accent-700)", "marginTop": "var(--size-24)"}}>{"Data"}</div>
<div style={{"marginTop": "var(--size-8)", "display": "flex", "flexDirection": "column", "gap": "var(--size-8)"}}>
<button type="button" onClick={v.onExport} style={{"fontSize": "var(--size-13)", "letterSpacing": ".12em", "textTransform": "uppercase", "padding": "var(--size-12)"}} className="btn btn-secondary btn-block">{"Export CSV"}</button>
<button type="button" onClick={v.onSeed} style={{"fontSize": "var(--size-13)", "letterSpacing": ".12em", "textTransform": "uppercase", "padding": "var(--size-12)"}} className="btn btn-secondary btn-block">{"Restore sample log"}</button>
...
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-12)", "letterSpacing": ".1em", "textTransform": "uppercase", "color": "var(--color-neutral-700)", "marginTop": "var(--size-4)"}}>{(v.d.rate) + " / hour · " + (v.d.bbRate) + " bb/h"}</div>
</div>
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-11)", "letterSpacing": ".16em", "textTransform": "uppercase", "color": "var(--color-accent-700)", "marginTop": "var(--size-22)"}}>{"Breakdown"}</div>
<div style={{"marginTop": "var(--size-6)", "borderTop": "var(--size-1) solid var(--color-divider)"}}>
...
<span style={{"fontSize": "var(--size-13)", "color": "var(--color-neutral-800)"}}>{l.label}</span>
<span style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-17)", "fontVariantNumeric": "tabular-nums", "color": l.color}}>{l.value}</span>
</div>
...
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-10)", "letterSpacing": ".14em", "textTransform": "uppercase", "color": "var(--color-accent-700)"}}>{"Notes"}</div>
<div style={{"fontSize": "var(--size-13)", "lineHeight": "1.5", "marginTop": "var(--size-3)"}}>{v.d.notes}</div>
</div>

</>}
<button type="button" onClick={v.onDelete} style={{"marginTop": "var(--size-20)", "fontSize": "var(--size-12)", "letterSpacing": ".14em", "textTransform": "uppercase", "padding": "var(--size-12)"}} className="btn btn-secondary btn-block">{"Delete session"}</button>
</div>
...
<button type="button" onClick={v.onCancelNew} style={{"background": "transparent", "border": "0", "padding": "var(--size-6) 0", "cursor": "pointer", "color": "var(--color-accent-700)", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-12)", "letterSpacing": ".14em", "textTransform": "uppercase"}}>{"Cancel"}</button>
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-12)", "letterSpacing": ".18em", "textTransform": "uppercase"}}>{"New session"}</div>
<div style={{"width": "var(--size-48)"}}></div>
</div>
<div style={{"flex": "1", "overflowY": "auto", "padding": "0 var(--size-20)"}}>
{v.showQuick && <>

<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-10)", "letterSpacing": ".16em", "textTransform": "uppercase", "color": "var(--color-accent-700)", "marginTop": "var(--size-12)"}}>{"One tap · starts immediately"}</div>
...
<span style={{"display": "block", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-15)", "color": "var(--color-accent-700)"}}>{p.label}</span>
<span style={{"display": "block", "fontSize": "var(--size-11)", "color": "var(--color-neutral-700)", "whiteSpace": "nowrap", "overflow": "hidden", "textOverflow": "ellipsis"}}>{p.sub}</span>
</button>
...
<button type="button" onClick={s.onClick} style={{"width": "100%", "display": "flex", "alignItems": "center", "gap": "var(--size-10)", "textAlign": "left", "background": "transparent", "border": "0", "borderBottom": "var(--size-1) solid var(--color-divider)", "padding": "var(--size-11) var(--size-2)", "cursor": "pointer", "fontFamily": "var(--font-body)", "fontSize": "var(--size-14)", "color": "var(--color-text)"}} className="interaction-6">
<span style={{"flex": "1"}}>{s.label}</span>
<span style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-15)", "color": "var(--color-accent-700)"}}>{s.value}</span>
<svg aria-hidden="true" focusable="false" width={"14"} height={"14"} viewBox={"0 0 24 24"} fill={"none"} stroke={"var(--color-neutral-500)"} strokeWidth={"1.5"}><path d={"M9 6l6 6-6 6"}></path></svg>
</button>
...
<button type="button" onClick={v.onStart} disabled={v.startDisabled} style={{"width": "100%", "margin": "var(--size-16) 0 var(--size-14)", "padding": "var(--size-14)", "background": "var(--color-accent)", "color": "var(--color-bg)", "borderColor": "var(--color-accent)", "cursor": "pointer", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-16)", "letterSpacing": ".14em", "textTransform": "uppercase", "opacity": v.startOpacity}} className="blueprint"><i aria-hidden="true" className="corner tl"></i><i aria-hidden="true" className="corner tr"></i><i aria-hidden="true" className="corner bl"></i><i aria-hidden="true" className="corner br"></i>{"Start · clock runs"}</button>
</div>
...
<button aria-label={k.label === "⌫" ? "Delete digit" : k.label} type="button" onClick={k.onClick} style={{"height": "var(--size-48)", "background": "var(--color-bg)", "border": "var(--size-1) solid var(--color-divider)", "cursor": "pointer", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-24)", "color": "var(--color-text)"}} className="interaction-7 interaction-8">{k.label}</button>
...
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-11)", "letterSpacing": ".16em", "textTransform": "uppercase", "color": "var(--color-accent-700)", "marginTop": "var(--size-22)"}}>{"Buy-ins"}</div>
<div style={{"marginTop": "var(--size-6)", "borderTop": "var(--size-1) solid var(--color-divider)"}}>
{v.a.buyIns.map((b, index) => <Fragment key={b.id ?? index}>

<div style={{"display": "flex", "justifyContent": "space-between", "alignItems": "baseline", "padding": "var(--size-9) var(--size-2)", "borderBottom": "var(--size-1) solid var(--color-divider)"}}>
<span style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-11)", "letterSpacing": ".12em", "textTransform": "uppercase", "color": "var(--color-neutral-700)"}}>{(b.label) + " · " + (b.at)}</span>
<span style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-17)", "fontVariantNumeric": "tabular-nums"}}>{b.amount}</span>
</div>
...
<div style={{"padding": "calc(var(--safe-top) + var(--size-10)) var(--size-20) 0", "display": "flex", "alignItems": "center", "justifyContent": "space-between"}}>
<button type="button" onClick={v.goActive} style={{"background": "transparent", "border": "0", "padding": "var(--size-6) 0", "cursor": "pointer", "color": "var(--color-accent-700)", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-12)", "letterSpacing": ".14em", "textTransform": "uppercase"}}>{"Back"}</button>
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-12)", "letterSpacing": ".18em", "textTransform": "uppercase"}}>{"Cash out"}</div>
...
<span style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-10)", "letterSpacing": ".16em", "textTransform": "uppercase", "color": "var(--color-accent-700)", "paddingBottom": "var(--size-6)"}}>{"Chips off table"}</span>
<span style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-46)", "lineHeight": "1", "fontVariantNumeric": "tabular-nums"}}><output aria-label="Chips off table amount">{v.cashText}</output></span>
</button>
...
<span style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-10)", "letterSpacing": ".16em", "textTransform": "uppercase", "color": "var(--color-accent-700)", "paddingBottom": "var(--size-6)"}}>{"Tips & rake paid"}</span>
<span style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-32)", "lineHeight": "1", "fontVariantNumeric": "tabular-nums"}}><output aria-label="Tips amount">{v.tipsText}</output></span>
</button>
<div style={{"marginTop": "var(--size-18)", "padding": "var(--size-12) var(--size-14)"}} className="blueprint"><i aria-hidden="true" className="corner tl"></i><i aria-hidden="true" className="corner tr"></i><i aria-hidden="true" className="corner bl"></i><i aria-hidden="true" className="corner br"></i>
<div style={{"display": "flex", "justifyContent": "space-between", "alignItems": "baseline"}}>
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-10)", "letterSpacing": ".16em", "textTransform": "uppercase", "color": "var(--color-accent-700)"}}>{"Net result"}</div>
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-11)", "letterSpacing": ".1em", "textTransform": "uppercase", "color": "var(--color-neutral-600)"}}>{(v.outDur) + " · " + (v.outRate) + "/h"}</div>
</div>
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-46)", "lineHeight": "1.05", "fontVariantNumeric": "tabular-nums", "color": v.outColor}}>{v.outNet}</div>
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-11)", "letterSpacing": ".1em", "textTransform": "uppercase", "color": "var(--color-neutral-700)", "marginTop": "var(--size-2)"}}>{v.outMath}</div>
</div>
<button type="button" onClick={v.onConfirm} style={{"width": "100%", "margin": "var(--size-16) 0 var(--size-14)", "padding": "var(--size-14)", "background": "var(--color-accent)", "color": "var(--color-bg)", "borderColor": "var(--color-accent)", "cursor": "pointer", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-16)", "letterSpacing": ".14em", "textTransform": "uppercase", "opacity": v.confirmOpacity}} className="blueprint"><i aria-hidden="true" className="corner tl"></i><i aria-hidden="true" className="corner tr"></i><i aria-hidden="true" className="corner bl"></i><i aria-hidden="true" className="corner br"></i>{"Book session"}</button>
</div>
<div style={{"background": "var(--color-surface)", "borderTop": "var(--size-1) solid var(--color-divider)", "padding": "var(--size-8) var(--size-6) max(var(--size-8), var(--safe-bottom))", "flex": "none"}}>
<div style={{"display": "grid", "gridTemplateColumns": "repeat(3,1fr)", "gap": "var(--size-1)"}}>
{v.padKeys.map((k, index) => <Fragment key={k.id ?? index}>
...
<span style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-9)", "letterSpacing": ".14em", "textTransform": "uppercase"}}>{t.label}</span>
</button>
...
<span style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-9)", "letterSpacing": ".14em", "textTransform": "uppercase"}}>{v.plusLabel}</span>
</button>
</div>
...
<div style={{"padding": "calc(var(--safe-top) + var(--size-10)) var(--size-20) 0", "display": "flex", "alignItems": "center", "justifyContent": "space-between"}}>
<button type="button" onClick={v.impCancel} style={{"background": "transparent", "border": "0", "padding": "var(--size-6) 0", "cursor": "pointer", "color": "var(--color-accent-700)", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-12)", "letterSpacing": ".14em", "textTransform": "uppercase"}}>{"Cancel"}</button>
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-12)", "letterSpacing": ".18em", "textTransform": "uppercase"}}>{"Import · step " + (v.impStep) + "/3"}</div>
<div style={{"width": "var(--size-48)"}}></div>
</div>
<div style={{"flex": "1", "overflowY": "auto", "padding": "0 var(--size-20) var(--size-24)"}}>
{v.impPick && <>

<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-30)", "letterSpacing": ".01em", "marginTop": "var(--size-14)"}}>{"ANALYTICS7"}</div>
<div style={{"fontSize": "var(--size-13)", "lineHeight": "1.5", "color": "var(--color-neutral-800)", "marginTop": "var(--size-2)"}}>{"Export the model file from analytics7, then pick it here. Cash sessions, venues, buy-ins, chip counts and tips come across; hand histories are ignored."}</div>
...
<span style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-16)", "letterSpacing": ".1em", "textTransform": "uppercase"}}>{"Choose .xml file"}</span>
<span style={{"fontSize": "var(--size-11)", "color": "var(--color-neutral-700)", "fontFamily": "var(--font-heading)", "letterSpacing": ".1em", "textTransform": "uppercase"}}>{"Files · iCloud · AirDrop"}</span>
...
<div role="alert" style={{"marginTop": "var(--size-12)", "borderLeft": "var(--size-2) solid var(--color-neutral-900)", "padding": "var(--size-8) var(--size-12)", "fontSize": "var(--size-13)", "background": "var(--color-neutral-200)"}}>{v.impError}</div>

</>}
<button type="button" onClick={v.onUseSample} style={{"marginTop": "var(--size-14)", "fontSize": "var(--size-12)", "letterSpacing": ".12em", "textTransform": "uppercase", "padding": "var(--size-12)"}} className="btn btn-secondary btn-block">{"Use the sample export"}</button>
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-11)", "letterSpacing": ".16em", "textTransform": "uppercase", "color": "var(--color-accent-700)", "marginTop": "var(--size-26)"}}>{"What is read"}</div>
<div style={{"marginTop": "var(--size-6)", "borderTop": "var(--size-1) solid var(--color-divider)"}}>
...
<span style={{"flex": "1", "fontSize": "var(--size-12)", "fontFamily": "var(--font-body)", "color": "var(--color-neutral-800)"}}>{m.from}</span>
...
<span style={{"flex": "1", "textAlign": "right", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-14)", "letterSpacing": ".04em", "color": m.color}}>{m.to}</span>
</div>
...
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-10)", "letterSpacing": ".16em", "textTransform": "uppercase", "color": "var(--color-accent-700)"}}>{"File read"}</div>
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-44)", "lineHeight": "1", "fontVariantNumeric": "tabular-nums", "marginTop": "var(--size-4)"}}>{v.impCount}</div>
...
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-11)", "letterSpacing": ".16em", "textTransform": "uppercase", "color": "var(--color-accent-700)", "marginTop": "var(--size-22)"}}>{"Amounts arrive in " + (v.impCode)}</div>
...
<span style={{"flex": "1"}}>
<span style={{"display": "block", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-15)", "letterSpacing": ".04em"}}>{m.label}</span>
<span style={{"display": "block", "fontSize": "var(--size-11)", "color": "var(--color-neutral-700)"}}>{m.sub}</span>
</span>
</button>

</Fragment>)}
</div>
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-11)", "letterSpacing": ".16em", "textTransform": "uppercase", "color": "var(--color-accent-700)", "marginTop": "var(--size-22)"}}>{"Duplicates"}</div>
...
<span style={{"flex": "1", "fontSize": "var(--size-13)"}}>{v.impDupeLine}</span>
<button type="button" onClick={v.impToggleSkip} style={{"background": v.skipBg, "color": v.skipFg, "border": "var(--size-1) solid var(--color-accent)", "padding": "var(--size-5) var(--size-10)", "cursor": "pointer", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-11)", "letterSpacing": ".12em", "textTransform": "uppercase"}}>{v.skipLabel}</button>
</div>
<button type="button" onClick={v.impToReview} style={{"width": "100%", "marginTop": "var(--size-18)", "padding": "var(--size-14)", "background": "var(--color-accent)", "color": "var(--color-bg)", "borderColor": "var(--color-accent)", "cursor": "pointer", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-16)", "letterSpacing": ".14em", "textTransform": "uppercase"}} className="blueprint interaction-14"><i aria-hidden="true" className="corner tl"></i><i aria-hidden="true" className="corner tr"></i><i aria-hidden="true" className="corner bl"></i><i aria-hidden="true" className="corner br"></i>{"Review " + (v.impCount) + " rows"}</button>
...
<div style={{"marginTop": "var(--size-16)", "padding": "var(--size-14) var(--size-16)"}} className="blueprint"><i aria-hidden="true" className="corner tl"></i><i aria-hidden="true" className="corner tr"></i><i aria-hidden="true" className="corner bl"></i><i aria-hidden="true" className="corner br"></i>
<div style={{"display": "flex", "alignItems": "baseline", "justifyContent": "space-between"}}>
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-10)", "letterSpacing": ".16em", "textTransform": "uppercase", "color": "var(--color-accent-700)"}}>{"Net of the import"}</div>
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-11)", "letterSpacing": ".1em", "textTransform": "uppercase", "color": "var(--color-neutral-600)"}}>{(v.impHours) + " h"}</div>
</div>
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-44)", "lineHeight": "1", "fontVariantNumeric": "tabular-nums", "color": v.impNetColor, "marginTop": "var(--size-2)"}}>{v.impNet}</div>
<div style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-12)", "letterSpacing": ".1em", "textTransform": "uppercase", "color": "var(--color-neutral-700)", "marginTop": "var(--size-3)"}}>{v.impAddLine}</div>
</div>
<div style={{"marginTop": "var(--size-18)", "borderTop": "var(--size-1) solid var(--color-divider)"}}>
...
<span style={{"width": "var(--size-38)", "height": "var(--size-34)", "flex": "none", "border": "var(--size-1) solid var(--color-divider)", "display": "grid", "placeItems": "center", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-12)", "color": "var(--color-accent-700)"}}>{r.stakes}</span>
<span style={{"flex": "1", "minWidth": "0"}}>
<span style={{"display": "block", "fontSize": "var(--size-13)", "fontWeight": "500", "whiteSpace": "nowrap", "overflow": "hidden", "textOverflow": "ellipsis"}}>{r.venue}</span>
<span style={{"display": "block", "fontSize": "var(--size-10)", "color": "var(--color-neutral-600)", "fontFamily": "var(--font-heading)", "letterSpacing": ".1em", "textTransform": "uppercase"}}>{r.meta}</span>
</span>
<span style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-10)", "letterSpacing": ".12em", "textTransform": "uppercase", "color": r.tagColor, "flex": "none"}}>{r.tag}</span>
<span style={{"fontFamily": "var(--font-heading)", "fontSize": "var(--size-17)", "fontVariantNumeric": "tabular-nums", "color": r.color, "flex": "none", "minWidth": "var(--size-74)", "textAlign": "right"}}>{r.net}</span>
</div>

</Fragment>)}
</div>
<button disabled={v.impAdd === 0} type="button" onClick={v.impCommit} style={{"width": "100%", "marginTop": "var(--size-18)", "padding": "var(--size-14)", "background": "var(--color-accent)", "color": "var(--color-bg)", "borderColor": "var(--color-accent)", "cursor": "pointer", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-16)", "letterSpacing": ".14em", "textTransform": "uppercase"}} className="blueprint interaction-15"><i aria-hidden="true" className="corner tl"></i><i aria-hidden="true" className="corner tr"></i><i aria-hidden="true" className="corner bl"></i><i aria-hidden="true" className="corner br"></i>{v.impCommitLabel}</button>
<button type="button" onClick={v.impBack} style={{"marginTop": "var(--size-8)", "fontSize": "var(--size-12)", "letterSpacing": ".12em", "textTransform": "uppercase", "padding": "var(--size-12)"}} className="btn btn-secondary btn-block">{"Back to mapping"}</button>
...
<div role="status" aria-live="polite" style={{"position": "absolute", "left": "var(--size-20)", "right": "var(--size-20)", "bottom": "var(--size-104)", "zIndex": "90", "background": "var(--color-accent-900)", "color": "var(--color-bg)", "padding": "var(--size-11) var(--size-14)", "fontFamily": "var(--font-heading)", "fontSize": "var(--size-12)", "letterSpacing": ".12em", "textTransform": "uppercase", "animation": "lg-fade .15s ease-out"}}>{v.toast}</div>
